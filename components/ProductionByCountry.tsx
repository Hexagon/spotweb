  ...
  for(const country of countries) {
    ...
    if (res) countryElms.push((
      <tr class="font-size-18 bg-dark">
        ...
        <td><span data-t-key={"common.generation.psr_"+res?.primary_psr_group}></span><span> ({Math.round((res.primary_psr_group_generation as number)/(res.generation_total as number)*100)}%)</span></td>
      </tr>
    ));
