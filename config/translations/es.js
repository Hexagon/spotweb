const es = {
  "common": {
    ...
    "warning": {
      ...
      "actual_price_text":
        "Actualmente tiene activado el precio de la electricidad, pero no ha realizado ninguna configuración para impuestos y tarifas. Haga clic en el menú de hamburguesas y complete el Factor (por ejemplo, 1,25 para el 25 % de IVA) y su tarifa (por ejemplo, 0,095 para 9,5 öre/kWh antes del IVA )",
    },
    "information": {
