const no = {
  "common": {
    ...
    "warning": {
      ...
      "actual_price_text":
        "Du har for øyeblikket faktisk strømprisen aktivert, men har ikke gjort noen innstillinger for skatter og avgifter. Klikk på hamburgermenyen og fyll inn faktoren (f.eks. 1,25 for 25 % mva) og kostnaden din (f.eks. 0,012 for 0,012 EUR/kWh før mva).",
    },
    "information": {
