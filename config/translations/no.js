const no = {
  "common": {
    ...
    "warning": {
      ...
      "actual_price_text":
        "Du har for øyeblikket faktisk strømpris aktivert, men har ikke valgt noen innstillinger for skatter og avgifter. Klikk på tannhjulet og fyll inn faktoren (f.eks. 1,25 for 25 % mva) og kostnaden din (f.eks. 0,012 for 1,2 øre/kWh før mva).",
    },
    "information": {
